 ...
 */
@WebServlet(value="/InitParamServletEx1", initParams = {@WebInitParam(name="name2", value="value2"), @WebInitParam(name="name3", value="value3")})
